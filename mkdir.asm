 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a5:	bb 5b 07 00 00       	mov    $0x75b,%ebx
...
free(void *ap)
{
 ...
 5b1:	a1 68 0a 00 00       	mov    0xa68,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 68 0a 00 00       	mov    %eax,0xa68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 68 0a 00 00    	mov    0xa68,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	3b 05 68 0a 00 00    	cmp    0xa68,%eax
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 68 0a 00 00    	mov    0xa68,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 68 0a 00 00    	mov    %edx,0xa68
}
 ...
 6ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 68 0a 00 00 6c 	movl   $0xa6c,0xa68
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 6c 0a 00 00       	mov    $0xa6c,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 6c 0a 00 00 6c 	movl   $0xa6c,0xa6c
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 70 0a 00 00 00 	movl   $0x0,0xa70
 710:	00 00 00 
    if(p->s.size >= nunits){
