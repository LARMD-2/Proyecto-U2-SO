...
fork1(void)
{
  ...
  exit();
     ...
     10b:	68 24 13 00 00       	push   $0x1324
     110:	6a 02                	push   $0x2
    ...
    panic("fork");
     ...
     122:	68 7e 12 00 00       	push   $0x127e
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 18 13 00 00       	push   $0x1318
     17e:	6a 02                	push   $0x2
...
00000190 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 7e 12 00 00       	push   $0x127e
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 3c 13 00 00 	jmp    *0x133c(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 8a 12 00 00       	push   $0x128a
     1ee:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2ad:	68 83 12 00 00       	push   $0x1283
     2b2:	e8 b9 fe ff ff       	call   170 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2b7:	51                   	push   %ecx
     2b8:	ff 73 08             	push   0x8(%ebx)
     2bb:	68 9a 12 00 00       	push   $0x129a
     2c0:	6a 02                	push   $0x2
     2c2:	e8 a9 0c 00 00       	call   f70 <printf>
      exit();
     2c7:	e8 47 0b 00 00       	call   e13 <exit>
      panic("pipe");
     2cc:	83 ec 0c             	sub    $0xc,%esp
     2cf:	68 aa 12 00 00       	push   $0x12aa
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     347:	6a 54                	push   $0x54
     349:	e8 42 0e 00 00       	call   1190 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     377:	6a 18                	push   $0x18
     379:	e8 12 0e 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3c7:	6a 0c                	push   $0xc
     3c9:	e8 c2 0d 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     407:	6a 0c                	push   $0xc
     409:	e8 82 0d 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     447:	6a 08                	push   $0x8
     449:	e8 42 0d 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 94 19 00 00       	push   $0x1994
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 94 19 00 00       	push   $0x1994
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 8c 19 00 00       	push   $0x198c
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 94 19 00 00       	push   $0x1994
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 94 19 00 00       	push   $0x1994
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 cc 12 00 00       	push   $0x12cc
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     6d0:	6a 18                	push   $0x18
     6d2:	e8 b9 0a 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     72f:	6a 18                	push   $0x18
     731:	e8 5a 0a 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     78e:	68 af 12 00 00       	push   $0x12af
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     7af:	68 cf 12 00 00       	push   $0x12cf
     7b4:	56                   	push   %esi
     7b5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     7cb:	6a 54                	push   $0x54
     7cd:	e8 be 09 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     816:	68 e6 12 00 00       	push   $0x12e6
     81b:	56                   	push   %esi
     81c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     860:	68 d8 12 00 00       	push   $0x12d8
  ...
  cmd->eargv[argc] = 0;
     ...
     8a9:	68 d1 12 00 00       	push   $0x12d1
...
000008c0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8d9:	68 eb 12 00 00       	push   $0x12eb
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     91d:	e8 6e 08 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000950 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     982:	e8 09 08 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     9ab:	68 ed 12 00 00       	push   $0x12ed
     9b0:	57                   	push   %edi
     9b1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9c1:	68 e9 12 00 00       	push   $0x12e9
     9c6:	57                   	push   %edi
     9c7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     9fd:	e8 8e 07 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000a30 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a3f:	68 cf 12 00 00       	push   $0x12cf
     a44:	56                   	push   %esi
     a45:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a69:	68 0b 13 00 00       	push   $0x130b
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ad5:	ff 24 85 54 13 00 00 	jmp    *0x1354(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 99 12 00 00       	push   $0x1299
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 0d 13 00 00       	push   $0x130d
     bb5:	6a 02                	push   $0x2
     bb7:	e8 b4 03 00 00       	call   f70 <printf>
    panic("syntax");
     bbc:	c7 04 24 d1 12 00 00 	movl   $0x12d1,(%esp)
     ...
     ed8:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f0b:	0f b6 92 c4 13 00 00 	movzbl 0x13c4(%edx),%edx
     ...
     f79:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     f93:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fd6:	0f 84 04 01 00 00    	je     10e0 <printf+0x170>
     fdc:	83 e8 63             	sub    $0x63,%eax
     fdf:	83 f8 15             	cmp    $0x15,%eax
     fe2:	77 1c                	ja     1000 <printf+0x90>
     fe4:	ff 24 85 6c 13 00 00 	jmp    *0x136c(,%eax,4)
     ...
     ff6:	5d                   	pop    %ebp
     ff7:	c3                   	ret
     ff8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     fff:	00 
  write(fd, &c, 1);
    ...
    1051:	e9 67 ff ff ff       	jmp    fbd <printf+0x4d>
        s = (char*)*ap;
    1056:	8b 45 d0             	mov    -0x30(%ebp),%eax
    1059:	8b 18                	mov    (%eax),%ebx
        ap++;
    105b:	83 c0 04             	add    $0x4,%eax
    105e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    1061:	85 db                	test   %ebx,%ebx
    1063:	0f 84 87 00 00 00    	je     10f0 <printf+0x180>
        while(*s != 0){
    1069:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    106c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    106e:	84 c0                	test   %al,%al
    1070:	0f 84 47 ff ff ff    	je     fbd <printf+0x4d>
    1076:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1079:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    107c:	89 de                	mov    %ebx,%esi
    107e:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
    1080:	83 ec 04             	sub    $0x4,%esp
    1083:	88 45 e7             	mov    %al,-0x19(%ebp)
          s++;
  ...
  write(fd, &c, 1);
    ...
    10a1:	e9 17 ff ff ff       	jmp    fbd <printf+0x4d>
        printint(fd, *ap, 10, 1);
    10a6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    10a9:	83 ec 0c             	sub    $0xc,%esp
    10ac:	b9 0a 00 00 00       	mov    $0xa,%ecx
    10b1:	8b 13                	mov    (%ebx),%edx
    10b3:	6a 01                	push   $0x1
    10b5:	eb 88                	jmp    103f <printf+0xcf>
        putc(fd, *ap);
    10b7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    10ba:	83 ec 04             	sub    $0x4,%esp
    10bd:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    10c0:	8b 03                	mov    (%ebx),%eax
        ap++;
    10c2:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    10c5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    10c8:	6a 01                	push   $0x1
    10ca:	52                   	push   %edx
    10cb:	57                   	push   %edi
    10cc:	e8 62 fd ff ff       	call   e33 <write>
        ap++;
    10d1:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    10d4:	83 c4 10             	add    $0x10,%esp
      state = 0;
    10d7:	31 d2                	xor    %edx,%edx
    10d9:	e9 df fe ff ff       	jmp    fbd <printf+0x4d>
  ...
  write(fd, &c, 1);
    ...
    10e9:	6a 01                	push   $0x1
    10eb:	e9 31 ff ff ff       	jmp    1021 <printf+0xb1>
    10f0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    10f5:	bb 32 13 00 00       	mov    $0x1332,%ebx
    10fa:	e9 77 ff ff ff       	jmp    1076 <printf+0x106>
    10ff:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1101:	a1 04 1a 00 00       	mov    0x1a04,%eax
{
  ...
  freep = p;
    ...
    113f:	5b                   	pop    %ebx
  freep = p;
    1140:	a3 04 1a 00 00       	mov    %eax,0x1a04
}
    1145:	5e                   	pop    %esi
    1146:	5f                   	pop    %edi
    1147:	5d                   	pop    %ebp
    ...
    1156:	72 ce                	jb     1126 <free+0x26>
{
  ...
  freep = p;
    117a:	a3 04 1a 00 00       	mov    %eax,0x1a04
    p->s.size += bp->s.size;
    117f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    1182:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    1185:	89 08                	mov    %ecx,(%eax)
}
    1187:	5b                   	pop    %ebx
    1188:	5e                   	pop    %esi
    1189:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    119c:	8b 15 04 1a 00 00    	mov    0x1a04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11db:	3b 05 04 1a 00 00    	cmp    0x1a04,%eax
    11e1:	75 ed                	jne    11d0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    11e3:	83 ec 0c             	sub    $0xc,%esp
    11e6:	56                   	push   %esi
    11e7:	e8 af fc ff ff       	call   e9b <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    1203:	8b 15 04 1a 00 00    	mov    0x1a04,%edx
    ...
    122c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    122f:	89 15 04 1a 00 00    	mov    %edx,0x1a04
}
    ...
    123f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1240:	c7 05 04 1a 00 00 08 	movl   $0x1a08,0x1a04
    1247:	1a 00 00 
    base.s.size = 0;
    124a:	b8 08 1a 00 00       	mov    $0x1a08,%eax
    base.s.ptr = freep = prevp = &base;
    124f:	c7 05 08 1a 00 00 08 	movl   $0x1a08,0x1a08
    1256:	1a 00 00 
    base.s.size = 0;
    1259:	c7 05 0c 1a 00 00 00 	movl   $0x0,0x1a0c
    1260:	00 00 00 
    if(p->s.size >= nunits){
